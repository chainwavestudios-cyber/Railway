        ...
        dgWs.on('open', () => {
          ...
          const prompt = [
            ...
            'PHASE 3 - OBJECTIONS (LITERAL SCRIPT)',
              'OBJECTION: Its to late, silver has already moved up',
            '"I understand the thought... I\'m too late to the party. But just remember for a second, when Bitcoin was at ten thousand. EVERYONE thought it was the top, yet in the end that created a new floor."',
